...
use survivor_valhalla::models::{BeastLineup, PlayerEnergy, AttackLineup};
...
pub fn deploy_beast_actions(world: @WorldStorage) -> IBeastActionsDispatcher {
    IBeastActionsDispatcher { 
        contract_address: starknet::contract_address_const::<0x1>() 
    }
}

pub fn deploy_battle_actions(world: @WorldStorage) -> IBattleActionsDispatcher {
    IBattleActionsDispatcher { 
        contract_address: starknet::contract_address_const::<0x2>() 
    }
}

pub fn deploy_energy_actions(world: @WorldStorage) -> IEnergyActionsDispatcher {
    IEnergyActionsDispatcher { 
        contract_address: starknet::contract_address_const::<0x3>() 
    }
}
