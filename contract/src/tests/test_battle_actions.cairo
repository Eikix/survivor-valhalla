...
mod test_battle_actions {
    ...
    use survivor_valhalla::models::{AttackLineup, Battle, BeastLineup, PlayerEnergy};
    ...
    use survivor_valhalla::tests::test_world::{
        deploy_battle_actions, deploy_beast_actions, setup_world,
    };
    ...
    fn setup_battle_test() -> (
        WorldStorage,
        IBeastActionsDispatcher,
        IBattleActionsDispatcher,
        ContractAddress,
        ContractAddress,
    ) {
    ...
    fn test_energy_system() {
        ...
        let energy = PlayerEnergy {
            player: player1, energy: 5, last_refill_time: get_block_timestamp(),
        };
    ...
    fn test_energy_refill() {
        ...
        // Set energy to 0
        let energy = PlayerEnergy { player: player1, energy: 0, last_refill_time: 1000 };
        world.write_model(@energy);
